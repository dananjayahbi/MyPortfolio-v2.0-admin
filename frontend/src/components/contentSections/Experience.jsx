...
const Experience = () => {
  ...
  const handleAddExperience = () => {
    ...
    setNewExperience("");
    message.success(
      'Experience added locally. Click "Update Experience" to save changes.'
    );
  };
  ...
  return (
    <Card style={{ marginTop: "-20px" }}>
      ...
      <Form layout="vertical">
        ...
        <Button color="primary" variant="outlined" onClick={handleAddExperience}>
          Add Experience
        </Button>
      </Form>
      ...
      >
        <CloudUploadOutlined />Update Experience
      </Button>
    </Card>
  );
};
