...
const MyHobbies = () => {
  ...
  const handleAddHobby = () => {
    ...
    setNewHobby("");
    message.success(
      'Hobby added locally. Click "Update My Hobbies" to save changes.'
    );
  };
  ...
  return (
    <Card style={{ marginTop: "-20px" }}>
      ...
      <Form layout="vertical">
        ...
        <Button color="primary" variant="outlined" onClick={handleAddHobby}>
          Add Hobby
        </Button>
      </Form>
      ...
      >
        <CloudUploadOutlined />Update My Hobbies
      </Button>
    </Card>
  );
};
