...
const Skills = () => {
    ...
    const handleAddSkill = () => {
        ...
        setSkills((prevSkills) => {
            const existingSubTitle = prevSkills.find(skill => skill.title === currentSkill.title);
            if (existingSubTitle) {
                const existingTech = existingSubTitle.technologies.find(tech => tech.name === currentSkill.name);
                if (existingTech) {
                ...
                prevSkills.push({
                    ...
                    technologies: [{ name: currentSkill.name, image: currentSkill.image }]
                });
            }
            return [...prevSkills];
        });
        ...
        message.success('Skill added locally. Click "Update Skills" to save changes.');
    };
    ...
    return (
        <Card style={{ maxWidth: '800px', margin: 'auto', marginTop: '50px' }}>
            <Title level={2}>Update Skills Section</Title>
