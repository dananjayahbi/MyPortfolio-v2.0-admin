...
const ProjectByURLExp = () => {
  ...
  const handleCreateProject = async (values) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3000/api/projects/experimental/createByUrl",
        {
          method: "POST",
          headers: {
  ...
  const handleDeleteProject = async (id) => {
    ...
    const deleteUrl = hasLocalhostScreenshot
      ? "http://localhost:3000/api/projects/experimental/delete"
      : "http://localhost:3000/api/projects/experimental/deleteByUrl";
  ...
  return (
    <div style={{ maxWidth: "1200px", margin: "auto", padding: "20px" }}>
      ...
      <Paragraph style={{ textAlign: "center", color: "#fff" }}>
        Manage your experimental projects created using screenshot URLs.
      </Paragraph>
      ...
      <Modal
        title="Create a New Experimental Project"
