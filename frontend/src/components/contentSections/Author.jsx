...
import { Form, Input, Button, message, Typography, Card, DatePicker } from 'antd';
...
const Author = () => {
    ...
    return (
        <Card style={{ width: "600px", margin: 'auto' }}>
            <Title level={2}>Update Author Details</Title>
            <Form form={form} layout="vertical" onFinish={handleUpdateAuthor}>
                <Form.Item label="Name" name="name" rules={[{ required: true, message: 'Please enter the author name' }]}>
                    <Input />
                </Form.Item>
                <Form.Item label="Post" name="post" rules={[{ required: true, message: 'Please enter the author post' }]}>
                    <Input />
                </Form.Item>
                ...
                <Form.Item label="Freelance Status" name="freelance" rules={[{ required: true, message: 'Please enter freelance status' }]}>
                    <Input />
                </Form.Item>
                <Form.Item label="Residence" name="residence" rules={[{ required: true, message: 'Please enter residence' }]}>
                    <Input />
                </Form.Item>
                <Form.Item label="Email" name="email" rules={[{ required: true, message: 'Please enter a valid email', type: 'email' }]}>
                    <Input />
                </Form.Item>
                <Form.Item label="Phone" name="phone" rules={[{ required: true, message: 'Please enter a valid phone number' }]}>
                    <Input />
                </Form.Item>
                <Form.Item label="My Status" name="myStatus" rules={[{ required: true, message: 'Please enter your status' }]}>
                    <Input.TextArea />
                </Form.Item>
