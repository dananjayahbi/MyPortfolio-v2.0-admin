...
const FunFacts = () => {
    ...
    const handleAddFact = () => {
        ...
        setNewFact("");
        message.success('Fact added locally. Click "Update Fun Facts" to save changes.');
    };
    ...
    return (
        <Card style={{ maxWidth: "600px", margin: "auto", marginTop: "50px" }}>
            <Title level={2}>Update Fun Facts Section</Title>
            ...
            <Form layout="vertical">
                ...
                <Button type="dashed" onClick={handleAddFact}>
                    Add Fun Fact
                </Button>
            </Form>

            <Title level={4} style={{ marginTop: "20px" }}>Current Fun Facts</Title>
